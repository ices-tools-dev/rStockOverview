...
The following stocks, guilds, and ecoregions have been included in the overview. F~MSY~ F, SSB, and MSY B~trigger~ were downloaded from [ICES Stock Assessment Graphs](http://ices.dk/marine-data/tools/Pages/stock-assessment-graphs.aspx). Click the links to see the [aggregated data](github.com/ices-dk/rStockOverview/NordicCouncilRefPoints.csv) and [R code](github.com/ices-dk/rStockOverview/nordicIndicators.rmd) used to download and plot  [Figure 1](github.com/ices-dk/rStockOverview/Output/NordicCouncilRefPoints_ALL.png) and [Figure 2](github.com/ices-dk/rStockOverview/Output/NordicCouncilRefPoints_ecoregion-guild.png).
...
F/F~MSY~ and SSB/MSY B~trigger~ averaged by guild for all ecoregions. [Link to .png](github.com/ices-dk/rStockOverview/Output/NordicCouncilRefPoints_ALL.png)
...
F/F~MSY~ and SSB/MSY B~trigger~ averaged for each ecoregion and guild. [Link to .png](github.com/ices-dk/rStockOverview/Output/NordicCouncilRefPoints_ecoregion-guildL.png)
